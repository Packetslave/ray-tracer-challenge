...
int main() {
  ...
  camera.set_transform(view_transform(
      Tuple::point(8, 6, -8), Tuple::point(0, 3, 0), Tuple::vector(0, 1, 0)));
  ...
  floor_ceiling->set_transform(CreateScaling(20, 7, 20) *
                               CreateTranslation(0, 1, 0));
  auto floor_ceiling_pattern =
      CheckPattern(Color(0, 0, 0), Color(0.25, 0.25, 0.25));
  ...
  tabletop->set_transform(CreateTranslation(0, 3.1, 0) *
                          CreateScaling(3, 0.1, 2));
  auto tabletop_pattern = GradientPattern(Color(1, 0, 0), Color(0, 0, 1));
  tabletop_pattern.set_transform(CreateScaling(0.05, 0.05, 0.05) *
                                 CreateRotationY(0.1));
  ...
  leg1.reset(new Cube());
  leg1->set_transform(CreateTranslation(2.7, 1.5, -1.7) *
                      CreateScaling(0.1, 1.5, 0.1));
  leg1->set_material(leg_material);
  w.add(leg1);

  std::shared_ptr<Shape> leg2;
  leg2.reset(new Cube());
  leg2->set_transform(CreateTranslation(2.7, 1.5, 1.7) *
                      CreateScaling(0.1, 1.5, 0.1));
  ...
  leg3.reset(new Cube());
  leg3->set_transform(CreateTranslation(-2.7, 1.5, -1.7) *
                      CreateScaling(0.1, 1.5, 0.1));
  ...
  leg4.reset(new Cube());
  leg4->set_transform(CreateTranslation(-2.7, 1.5, 1.7) *
                      CreateScaling(0.1, 1.5, 0.1));
  ...
  //  glass_cube->set_transform(CreateTranslation(0, 3.45001, 0) *
  //  CreateRotationY(0.2) * CreateScaling(0.25, 0.25, 0.25));
  ...
  //  little_cube1->set_transform(CreateTranslation(1, 3.35, -0.9) *
  //  CreateRotationY(-0.4) * CreateScaling(0.15, 0.15, 0.15)); auto
  //  little_cube1_material = Material();std::make_shared<SolidPattern>(Color(1,
  //  0.5, 0.5))); little_cube1_material.set_reflective(0.6);
  ...
  //  little_cube2->set_transform(CreateTranslation(-1.5, 3.27, 0.3) *
  //  CreateRotationY(0.4) * CreateScaling(0.15, 0.07, 0.15)); auto
  //  little_cube2_material = Material();std::make_shared<SolidPattern>(Color(1,
  //  1, 0.5))); little_cube2->set_material(little_cube2_material);
  //
  //  // LITTLE CUBE #3
  //  auto little_cube3 = std::make_shared<Shape>(new Cube());
  //  little_cube3->set_transform(CreateTranslation(0, 3.25, 1) *
  //  CreateRotationY(0.4) * CreateScaling(0.2, 0.05, 0.05)); auto
  //  little_cube3_material =
  //  Material();std::make_shared<SolidPattern>(Color(0.5, 1, 0.5)));
  //  little_cube3->set_material(little_cube3_material);
  //
  //  // LITTLE CUBE #4
  //  auto little_cube4 = std::make_shared<Shape>(new Cube());
  //  little_cube4->set_transform(CreateTranslation(-0.6, 3.4, -1) *
  //  CreateRotationY(0.8) * CreateScaling(0.05, 0.2, 0.05)); auto
  //  little_cube4_material =
  //  Material();std::make_shared<SolidPattern>(Color(0.5, 0.5, 1)));
  //  little_cube4->set_material(little_cube4_material);
  //
  //  // LITTLE CUBE #5
  //  auto little_cube5 = std::make_shared<Shape>(new Cube());
  //  little_cube5->set_transform(CreateTranslation(2, 3.4, 1) *
  //  CreateRotationY(0.8) * CreateScaling(0.05, 0.2, 0.05)); auto
  //  little_cube5_material =
  //  Material();std::make_shared<SolidPattern>(Color(0.5, 1, 1)));
  //  little_cube5->set_material(little_cube5_material);
  //
  //  // FRAME #1
  //  auto frame1 = std::make_shared<Shape>(new Cube());
  //  frame1->set_transform(CreateTranslation(-10, 4, 1) * CreateScaling(0.05,
  //  1, 1)); auto frame1_material =
  //  Material();std::make_shared<SolidPattern>(Color(0.7098, 0.2471, 0.2196)));
  //  frame1_material.set_diffuse(0.6);
  //  frame1->set_material(frame1_material);
  //
  //  // FRAME #2
  //  auto frame2 = std::make_shared<Shape>(new Cube());
  //  frame2->set_transform(CreateTranslation(-10, 3.4, 2.7) *
  //  CreateScaling(0.05, 0.4, 0.4)); auto frame2_material =
  //  Material();std::make_shared<SolidPattern>(Color(0.2667, 0.2706, 0.602)));
  //  frame2_material.set_diffuse(0.6);
  //  frame2->set_material(frame2_material);
  //
  //  // FRAME #3
  //  auto frame3 = std::make_shared<Shape>(new Cube());
  //  frame3->set_transform(CreateTranslation(-10, 4.6, 2.7) *
  //  CreateScaling(0.05, 0.4, 0.4)); auto frame3_material =
  //  Material();std::make_shared<SolidPattern>(Color(0.3098, 0.5961, 0.3098)));
  //  frame3_material.set_diffuse(0.6);
  //  frame3->set_material(frame3_material);
  //
  //  // MIRROR FRAME
  //  auto mirror_frame = std::make_shared<Shape>(new Cube());
  //  mirror_frame->set_transform(CreateTranslation(-2, 3.5, 9.95) *
  //  CreateScaling(5, 1.5, 0.05)); auto mirror_frame_material =
  //  Material();std::make_shared<SolidPattern>(Color(0.3882, 0.2627, 0.1882)));
  ...
  mirror->set_transform(CreateTranslation(-2, 3.5, 9.95) *
                        CreateScaling(4.8, 1.4, 0.06));
  auto mirror_material = Material();
  std::make_shared<SolidPattern>(Color(0, 0, 0));
  ...
  //      glass_cube, little_cube1, little_cube2, little_cube3, little_cube4,
  //      little_cube5, frame1, frame2, frame3, mirror_frame, mirror
  //  };
