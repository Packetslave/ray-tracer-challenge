...
//   Matrix a({{-2, -8, 3, 5}, {-3, 1, 7, 3}, {1, 2, -9, 6}, {-6, 7, 7,
//   -9}}); ASSERT_EQ(690, a.cofactor(0, 0)); ASSERT_EQ(447, a.cofactor(0,
//   1)); ASSERT_EQ(210, a.cofactor(0, 2)); ASSERT_EQ(51, a.cofactor(0, 3));
